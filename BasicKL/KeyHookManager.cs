...
namespace BasicKL
{
    public class KeyHookManager : IDisposable
    {
        ...
        private static readonly short VK_SHIFT = 0x10;
        private static readonly short VK_CONTROL = 0x11;
        private static readonly short VK_MENU = 0x12;       // alt key

        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(KeyHookManager));
        ...
        private string KeyCodeToUnicode(Keys key)
        {
            ...
            // this doesn't handle dead keys... we'll call that out of scope for now
            // to fix: see msdn docs on ToUnicodeEx
